...
export default function AllNotesScreen() {
  ...
  const loadNotes = async () => {
    if (user) {
      const allNotes = await notesService.getAllNotes(user.id);
      const sorted = notesService.sortNotes(allNotes, sortAscending);
      setNotes(sorted);
  ...
  const handleSearch = async (query: string) => {
    ...
    if (query.trim() === '') {
      ...
      const sorted = notesService.sortNotes(results, sortAscending);
      setFilteredNotes(sorted);
    }
  };
