...
export default function WorkNotesScreen() {
  ...
  const loadNotes = async () => {
    if (user) {
      const workNotes = await notesService.getNotesByCategory(user.id, 'work');
      const sorted = notesService.sortNotes(workNotes, sortAscending);
      setNotes(sorted);
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No work notes</Text>
          </View>
        }
      />
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => router.push({ pathname: '/add-note', params: { category: 'work' } })}
      >
