...
export default function StudyNotesScreen() {
  ...
  const loadNotes = async () => {
    if (user) {
      const studyNotes = await notesService.getNotesByCategory(user.id, 'study');
      const sorted = notesService.sortNotes(studyNotes, sortAscending);
      setNotes(sorted);
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No study notes</Text>
          </View>
        }
      />
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => router.push({ pathname: '/add-note', params: { category: 'study' } })}
      >
